...
poor_score = filter_score[(filter_score["Credit Score"] > 0) & (filter_score["Credit Score"] <= 400)]  
...
fair_score = filter_score[(filter_score["Credit Score"] >= 400) & (filter_score["Credit Score"] <= 669)]  
